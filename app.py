...
ax.scatter([x.iloc[-1]], [filtered["cum_wins"].iloc[-1]],   color=WIN_COLOR,  s=80, zorder=5)
ax.scatter([x.iloc[-1]], [filtered["cum_losses"].iloc[-1]], color=LOSS_COLOR, s=80, zorder=5)
